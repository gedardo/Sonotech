...
import { Plus, Edit2, Trash2, Save, X, Lock, Eye, EyeOff } from 'lucide-react';
...
export function AdminPage() {
  ...
  const handleEdit = (product: Product) => {
    ...
    setFormData({
      ...
      dimensions: {
        ancho: product.dimensions?.ancho ?? 0,
        alto: product.dimensions?.alto ?? 0,
        profundidad: product.dimensions?.profundidad ?? 0,
      },
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-primary-100 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
          ...
          <form onSubmit={handleAuth} className="space-y-6">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all pr-12"
            ...
            <button
              type="submit"
              className="w-full bg-primary-600 hover:bg-primary-700 text-white px-6 py-3 rounded-xl font-semibold transition-all flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-500">
              Panel de administración de Levelpro
            </p>
          </div>
        </div>
      </div>
